...
<body>
    <div class="table-container">
        ...
        <div class="btn-group">
            <a href="../controllers/MatchsController.php?action=matches_a_venir" class="btn-index-match">
                Matchs à venir
            </a>
            <a href="../controllers/MatchsController.php?action=matches_passes" class="btn-index-match">
                Matchs passés
            </a>
        </div>
        
        <!-- Bouton "Ajouter un Match" -->
        <a href="../controllers/MatchsController.php?action=ajouter" class="btn-index-match">
            Ajouter un Match
        </a>
