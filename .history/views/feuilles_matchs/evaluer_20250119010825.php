...
<head>
    ...
    <script>
        // Rendre le champ d'évaluation modifiable lorsque la case est cochée
        function toggleEvaluation(checkbox, index) {
            const evaluationField = document.getElementById(`evaluation_${index}`);
            if (checkbox.checked) {
                evaluationField.disabled = false;
                evaluationField.focus();
            } else {
        ...
        // Valider les évaluations avant soumission
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        type="checkbox"
                                        id="checkbox_<?= $index ?>"
                                        onclick="toggleEvaluation(this, <?= $index ?>)">
                                </td>
                                <td>
                                    <input 
                                        type="number" 
