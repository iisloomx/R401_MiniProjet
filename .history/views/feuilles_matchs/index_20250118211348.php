...
<body>
    <div class="match-details">
        ...
        <div class="actions">
        <?php if ($match['etat_feuille'] === 'Non validé' || $match['statut'] === 'À venir'): ?>                <a href="FeuilleMatchController.php?action=valider_feuille&id_match=<?= htmlspecialchars($match['id_match']); ?>" 
