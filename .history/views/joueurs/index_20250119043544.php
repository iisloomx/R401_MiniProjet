...
<a href="../controllers/JoueursController.php?action=ajouter" class="btn btn-add btn-add-joueur">Ajouter un Joueur</a>
            ...
            <?php foreach ($joueurs as $joueur) : ?>
                <tr data-id="<?= htmlspecialchars($joueur['numero_licence']); ?>">
                    ...
                    <td>
                        ...
                        <a href="../controllers/CommentaireController.php?action=ajouter_commentaire&numero_licence=<?= htmlspecialchars($joueur['numero_licence']); ?>" class="btn btn-edit">Ajouter Commentaire</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
