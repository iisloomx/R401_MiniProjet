...
<body>
    <div class="container">
        ...
        <form action="StatistiqueController.php?action=joueurs" method="POST">
        ...
        <div class="return-button">
            <a href="StatistiqueController.php?action=index" class="btn-stat">Retour aux Statistiques</a>
        </div>
    </div>
</body>
</html>
