...
<body>
    <header class="main-header">
        <div class="logo">
            <a href="../controllers/ConnexionController.php"><img src="../img/logo.PNG" alt="Logo" /></a>
        </div>

        <nav class="nav-links">
            <?php if (isset($_SESSION['utilisateur'])) : ?>           <a href="../controllers/ConnexionController.php"><img src="../img/logo.PNG" alt="Logo" /></a>
