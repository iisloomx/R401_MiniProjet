        ...
        case 'ajouter':
            ...
            case 'evaluer':
                ...
                case 'valider_evaluation':
                    ...
                    // Ajouter un var_dump pour vérifier les données reçues
                    if (empty($evaluations)) {
                        echo "<pre>";
                        var_dump($_POST); // Vérifiez toutes les données POST
                        echo "</pre>";
                    ...
                    try {
                        foreach ($evaluations as $numero_licence => $evaluation) {
                            ...
                            if (!is_numeric($evaluation) || $evaluation < 1 || $evaluation > 5) {
                                echo "<pre>";
                                var_dump($numero_licence, $evaluation); // Débogage des données incorrectes
                                echo "</pre>";
