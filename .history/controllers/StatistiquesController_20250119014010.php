...
switch ($action) {
    case 'matchs':
        ...
        $stats = $statistiques->getMatchStatistics();
        require '../views/statistique_matchs.php';
        break;

    case 'joueurs':
        // Statistiques globales pour tous les joueurs
        $statsJoueurs = $statistiques->getGlobalPlayerStatistics();
    ...
    case 'selection_joueur':
        ...
        if ($numero_licence) {
            $consecutiveSelections = $statistiques->getConsecutiveSelections($numero_licence);
        }
    ...
    case 'joueur_global':
        ...
        if ($numero_licence) {
            $stats = $statistiques->getPlayerStatistics($numero_licence);
        }
