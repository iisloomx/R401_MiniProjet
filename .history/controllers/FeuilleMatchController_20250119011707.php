...
switch ($action) {
    ...
    case 'afficher':
        ...
        case 'ajouter':
            ...
            // Ajouter la moyenne des évaluations pour chaque joueur
                ...
                case 'valider_evaluation':
                    ...
                    try {
                        foreach ($evaluations as $id => $evaluation) {
                            // Validation de la valeur d'évaluation
                            if ($evaluation < 1 || $evaluation > 5) {
                                echo "<script>alert('Toutes les évaluations doivent être entre 1 et 5.'); window.location.href='FeuilleMatchController.php?action=evaluer&id_match=$id_match';</script>";
                                exit;
                            }
                
                            // Appeler la fonction pour mettre à jour l'évaluation
