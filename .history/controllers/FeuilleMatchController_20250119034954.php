            ...
            case 'evaluer':
                ...
                case 'valider_evaluation':
                    ...
                    try {
                        ...
                        echo "<script>alert('Évaluations enregistrées avec succès.'); window.location.href='FeuilleMatchController.php?action=afficher';</script>";
                        exit;
                    } catch (Exception $e) {
                        echo "<script>alert('Erreur lors de l\'enregistrement des évaluations : " . htmlspecialchars($e->getMessage()) . "'); window.location.href='FeuilleMatchController.php?action=afficher';</script>";
                        exit;
                    }
