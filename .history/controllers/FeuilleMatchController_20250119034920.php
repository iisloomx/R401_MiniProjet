        ...
        case 'ajouter':
            ...
            case 'evaluer':
                ...
                case 'valider_evaluation':
                    ...
                    if (!$id_match) {
                        echo "<script>alert('ID du match non spécifié.'); window.location.href='FeuilleMatchController.php?action=index';</script>";
                        exit;
                    }
                    ...
                    if (empty($evaluations)) {
                        echo "<script>alert('Aucune évaluation soumise.'); window.location.href='FeuilleMatchController.php?action=index';</script>";
                        exit;
                    }
                
                    $participerModel = new FeuilleMatch($db);
                    ...
                    try {
                        foreach ($evaluations as $numero_licence => $evaluation) {
                            ...
                            $participerModel->mettreAJourEvaluation($data);
                        }
                
                        // Redirection après succès
                        echo "<script>alert('Évaluations enregistrées avec succès.'); window.location.href='FeuilleMatchController.php?action=index';</script>";
                        exit;
                    } catch (Exception $e) {
                        echo "<script>alert('Erreur lors de l\'enregistrement des évaluations : " . htmlspecialchars($e->getMessage()) . "'); window.location.href='FeuilleMatchController.php?action=index';</script>";
                        exit;
                    }
