                ...
                <tbody>
                    <?php foreach ($joueurs as $j) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="JoueursController.php?action=modifier&numero_licence=<?= urlencode($j['numero_licence']); ?>" class="btn btn-edit">Modifier</a>
                                <a href="JoueursController.php?action=supprimer&numero_licence=<?= urlencode($j['numero_licence']); ?>" class="btn btn-delete" onclick="return confirm('Voulez-vous vraiment supprimer ce joueur ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
